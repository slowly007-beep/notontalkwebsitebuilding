...
export default function FinalCTA() {
  return (
    <section className="py-24 container">
      <Card className="relative overflow-hidden border-none bg-brand">
        {/* 배경 패턴 및 효과 */}
        ...
        <CardContent className="relative z-10 flex flex-col items-center text-center p-16 md:p-24 space-y-8">
          ...
          <p className="text-xl text-black/80 max-w-2xl font-medium">
            고민하는 시간에도 다른 사람들은 성장하고 있습니다.<br />
            NotionTalk과 함께 생산성의 한계를 뛰어넘으세요.
          </p>
          <Button size="lg" className="h-14 px-10 bg-black text-white hover:bg-gray-900 text-lg font-bold shadow-2xl hover:scale-105 transition-all duration-300 border-2 border-transparent hover:border-white/20">
